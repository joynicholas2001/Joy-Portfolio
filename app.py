...
def home():
    profile = {
        ...
        'gender': 'Male',
        'summary': (
            'Experienced Full Stack Developer and Graphic Designer with a strong background '
            'in Python, Flask, MySQL, AWS, and frontend technologies. Skilled in developing '
            'scalable web applications and digital marketing solutions.'
        ),
        'education': [
            {
                'period': '12/2020 – 11/2024',
            ...
            },
            {
                ...
                'degree': 'Intermediate',
                'institution': 'Sri Chaitanya Educational Institutions, Vijayawada',
                'cgpa': '5.67'
            },
            {
                'period': '03/2016 – 05/2017',
                'degree': 'SSC',
                'institution': 'Sri Chaitanya Educational Institutions, Mangalagiri',
                'cgpa': None  # 👈 Added None to keep consistent keys
            }
        ],
        'skills': [
        ...
        'certificates': [
            ...
            },
            {
                ...
                'details': (
                    'Trained in Python, MySQL, Flask, HTML, CSS, JavaScript, AWS. '
                    'Developed an E-Commerce Web Application using Flask.'
                ),
        ...
        'projects': [
            {
                ...
                'description': (
                    'Developed a full-featured e-commerce web application with user authentication, '
                    'product management, and order processing.'
                ),
                'link': 'https://art-gram-project-83dbjww3v-joynicholas2001s-projects.vercel.app'
            }
        ],
